...
from scripts.create_movielens_dataset import get_ratings_25m
...
df = get_ratings_25m(min_number_of_reviews=args.min_review_count, balanced_classes=args.balanced_classes)
